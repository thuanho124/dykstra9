...
namespace ContosoUniversity.Migrations
{
    public partial class Inheritance : Migration
    {
        ...
        {
            // remove foreign key and index point tp the student table
            migrationBuilder.DropForeignKey(
                name: "FK_Enrollment_Student_StudentID",
                table: "Enrollment");
            migrationBuilder.DropIndex(name: "IX_Enrollment_StudentID", table: "Enrollment");

            // rename the Instructor table to Person and add columns to store Student information
            migrationBuilder.RenameTable(name: "Instructor", newName: "Person");
            migrationBuilder.AddColumn<DateTime>(name: "EnrollmentDate", table: "Person", nullable: true);

            // Discriminator column checks whether a row is for a student or an instructor
            migrationBuilder.AddColumn<string>(name: "Discriminator", table: "Person", nullable: false, maxLength: 128, defaultValue: "Instructor");

            // HireDate is null since Student table does not have HireDate
            ...
            // Re-creates foreign key and index, which point to the Person table
